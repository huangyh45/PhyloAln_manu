...
sum_contam.py: a custom script to calculate the average percent completeness and identity, and precision and recall of clean, foreign and cross contamination reads of PhyloAln with the assembly step
sum_contam_b.py: a custom script to calculate the average percent completeness and identity, and precision and recall of clean, foreign and cross contamination reads of PhyloAln without the assembly step
